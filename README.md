# DevOps Foundations Training Pre-flight
...
Verify SSH and RDP connectivity:
* Outbound to AWS

### Network Requirements

Outbound: ports 22 (SSH), 3389 (RDP), and 5985 (WinRM), * .chef.io, * .aws.amazon.com, and if possible, drive.google.com
...
## On Windows
1. download or clone the chef-preflight-devops-foundations repository locally
2. open powershell as administrator
3. navigate to the chef-preflight-devops-foundationss folder
...
3. navigate to the chef-preflight-devops-foundations folder
...
If we assume a Windows workstation, then for the DevOps Foundations course:
...
3. And then execute the script located inside of: chef-preflight-devops-foundations -> windows_preflight.ps1

  * .\chef-preflight-devops-foundations\windows_preflight.ps1
